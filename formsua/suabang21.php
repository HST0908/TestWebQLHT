...
<?php 
    ...
    $id = $_REQUEST['id'];
    $sql = "SELECT * FROM bang21 WHERE id = $id";
                        ...
                        <div class="container_box">
                            ...
                            <form action="" method="post" class="formNhap">
                                <div class="container_box-content">
                                    ...
                                    <?php if($row['doituong']=="Nghiên cứu sinh"){
                                            echo '<select class="category_optionNhap" name="doituong">';
                                                echo '<option class="category_option--item" value="Nghiên cứu sinh" selected>Nghiên cứu sinh</option>';
                                                echo '<option class="category_option--item" value="Học viên cao học">Học viên cao học</option>';
                                            ...
                                            if($row['doituong']=="Học viên cao học"){
                                                echo '<select class="category_optionNhap" name="doituong">';
                                                echo '<option class="category_option--item" value="Nghiên cứu sinh">Nghiên cứu sinh</option>';
                                                echo '<option class="category_option--item" value="Học viên cao học" selected>Học viên cao học</option>';
                                                echo '<option class="category_option--item" value="Đại học">Đại học</option>';
                                                echo '<option class="category_option--item" value="Cao đẳng">Cao đẳng</option>';
                                                echo '<option class="category_option--item" value="Trung cấp">Trung cấp</option>';
                                                echo '<option class="category_option--item" value="Trình độ khác">Trình độ khác</option>';
                            ...
                            <?php }
                                if(isset($_POST['sua'])){
                                    ...
                                    $sql = "UPDATE `bang21` SET `doituong` = '$doituong', `sothisinh` = '$dutuyen', `sotrungtuyen` = '$trungtuyen', `sonhaphoc` = '$nhaphoc', `diemdauvao` = '$diemtuyen', `diemtb` = '$tbduoctuyen', `slsinhvienqt` = '$slsvqt', `namhoc` = '$year' WHERE `bang21`.`id` = $id";
                                    $result = mysqli_query($conn, $sql);
                                    if ($result) {
                                        echo '<script>alert("sửa thành công!");</script>';
                                        echo '<script>window.location.href = "../formxem/bang21.php"</script>';
                                    }
                                }
                            ?>
                        </div>
