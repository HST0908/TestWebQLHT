                        ...
                        <div class="container_box">
                            <form action="" method="post" class="formNhap">
                                ...
                                <div class="container_box-content">
                                    ...
                                    <div class="container_box-input"><input class="content_input--item--input" min="0" type="number" name="tongthuhocphi" placeholder="Tổng thu học phí" id="" required></div>
                                </div>
                                <!-- tách -->
                            ...
                            <?php
                                if(isset($_POST['Nhap'])){
                                    ...
                                    $kn = mysqli_query($conn, "SELECT * FROM bang43 WHERE  nam = '$year'");

                                    if(mysqli_num_rows($kn) > 0){
                                        echo '<script>alert("Dữ liệu của năm '.$year.' đã tồn tại!");</script>';
                                    } else {
                                        $sql = "INSERT INTO `bang43` (`id`,`nam`, `tongthuhocphi`) VALUES (NULL,'$year', '$tongthuhocphi')";
