                        ...
                        <div class="container_box">
                            <form action="" method="post" class="formNhap">
                                ...
                                <div class="container_box-content">
                                    ...
                                    <div class="container_box-input"><input class="content_input--item--input" min="0" type="number" name="chiHDDT" placeholder="Tổng chi cho đào tạo" id="" required></div>
                                </div>
                                <!-- tách -->
                            ...
                            <?php
                                if(isset($_POST['Nhap'])){
                                    ...
                                    $kn = mysqli_query($conn, "SELECT * FROM bang46 WHERE  nam = '$year'");

                                    if(mysqli_num_rows($kn) > 0){
                                        echo '<script>alert("Dữ liệu của năm '.$year.' đã tồn tại!");</script>';
                                    } else {
                                        $sql = "INSERT INTO `bang46` (`id`,`nam`,`chiHDDT`) VALUES (NULL,'$year','$chiHDDT')";
