                        ...
                        <div class="container_box">
                                ...
                                <div class="container_box-content">
                                    ...
                                    <div class="container_box-input">
                                        <select class="category_optionNhap" name="doituong">
                                            ...
                                            <option class="category_option--item" value="Bồi dưỡng">Bồi dưỡng</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- tách -->
                            ...
                            <?php
                                if(isset($_POST['Nhap'])){
                                    ...
                                    $slsvqt = $_POST['slsvqt'];
                                    $year = $_POST['year'];
                                    $kn = mysqli_query($conn, "SELECT * FROM bang22 WHERE doituong = '$doituong' AND namhoc = '$year'");
                                    ...
                                    elseif(mysqli_num_rows($kn) > 0){
                                        ...
                                        $sql ="INSERT INTO `bang22` (`id`, `doituong`, `sothisinh`, `sotrungtuyen`, `sonhaphoc`, `diemdauvao`, `diemtb`, `slsinhvienqt`, `namhoc`) VALUES (NULL, '$doituong', '$dutuyen', '$trungtuyen', '$nhaphoc', '$diemtuyen', '$tbduoctuyen', '$slsvqt', '$year')";
