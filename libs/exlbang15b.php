...
$myexcel->getActiveSheet()->setCellValue("F5", "Năm học");
...
$myexcel->getActiveSheet()->getStyle('A4:F5')->getFill()->setFillType(\PHPExcel_Style_Fill::FILL_SOLID);
$myexcel->getActiveSheet()->getStyle('A4:F5')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
header('Content-Disposition: attachment;filename="bang15b.xlsx"');
