...
<body>
    ...
    $sql2 = "create table bangmoi(loaitapchi char (100))";
    ...
    while ($row = mysqli_fetch_array($kq)) {
        ...
        for ($j = $nambd; $j <= $namkt; $j++) {
            $tam1 = $row[$i];
            $nam = "Nam" . $j;
            $sql2 = "update bangmoi set $nam=$tam1 where loaitapchi = '$tam'";
            $kq2 = mysqli_query($con, $sql2);
            $i++;
        }
    }
    ...
    header('Content-Disposition:attachment;filename=bang33.xls');
    echo $output;
    ?>
</body>
