...
$myexcel->getActiveSheet()->setTitle("bang47");
$myexcel->getActiveSheet()->setCellValue("A2", "BẢNG 47.  TỔNG CHI CHO PHÁT TRIỂN ĐỘI NGŨ")->mergeCells('A2:J2');
...
$sql = "SELECT * FROM bang47 where nam between $nambd and $namkt ORDER BY nam ASC";
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $myexcel->getActiveSheet()->setCellValue("E" . $i, number_format($row['chiPTdoingu'], 0, '.','.'));
...
header('Content-Disposition: attachment;filename="bang47.xlsx"');
