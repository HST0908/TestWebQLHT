...
<head>
    ...
    <title>SỐ LƯỢNG BÁO CÁO KHOA HỌC DO CÁN BỘ CƠ HỮU CỦA TRƯỜNG ĐẠI HỌC SƯ PHẠM KỸ THUẬT VINH BÁO CÁO TẠI CÁC HỘI NGHỊ, HỘI THẢO ĐƯỢC ĐĂNG TOÀN VĂN TRONG TUYỂN TẬP CÔNG TRÌNH HAY KỶ YẾU</title>
</head>
<body>
<?php 
    ...
    <div class="contain grid lager wide">
        <div class="row">
            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        <div class="container_header"><h3 class="heading_title">SỐ LƯỢNG BÁO CÁO KHOA HỌC DO CÁN BỘ CƠ HỮU CỦA TRƯỜNG ĐẠI HỌC SƯ PHẠM KỸ THUẬT VINH BÁO CÁO TẠI CÁC HỘI NGHỊ, HỘI THẢO ĐƯỢC ĐĂNG TOÀN VĂN TRONG TUYỂN TẬP CÔNG TRÌNH HAY KỶ YẾU</h3></div>
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang35.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    ...
                                    if(isset($_POST['xem'])){
                                        $nambd = $_POST['nambd'];
                                        $namkt = $_POST['namkt'];
                                        $sql1 = "SELECT * FROM bang35 where nam between $nambd and $namkt ORDER BY nam DESC";
                                        $result = mysqli_query($conn, $sql1);

                                        $sql = "select loaihoithao,";
                                            $i = $nambd;
                                            while ($i < $namkt) {
                                            ...
                                            $sql = $sql . " sum(if(nam=$i,soluong,0))as 'năm $i'";
                                            $sql = $sql . " FROM bang35 where nam between $nambd and $namkt GROUP BY loaihoithao";
                                        ...
                                        $sql = "SELECT * FROM bang35 order by nam desc";
                                        echo'<tr class="bangxem--title">
                                            <td class="bangxem-header">Loại hội thảo</td>
                                        ...
                                        while($row = mysqli_fetch_assoc($rs)){
                                            echo '<tr class="bangxem--title">';
                                                ...
                                                echo '<td>'.$row['nam'].'</td>';
                                                echo '<td><label class="btnsua"><a href="../formsua/suabang35.php?nam='.$row['nam'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                    ...
                                                    <label class="btnxoa"><a href="../formxoa/xoabang35.php?id='.$row['id'].'">
                                                    <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                    <lord-icon
