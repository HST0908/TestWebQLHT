            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        ...
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang33.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    ...
                                    if(isset($_POST['xem'])){
                                        $nambd = $_POST['nambd'];
                                        $namkt = $_POST['namkt'];
                                        $sql1 = "SELECT * FROM bang33 where nam between $nambd and $namkt ORDER BY nam";
                                        $result = mysqli_query($conn, $sql1);

                                        $sql = "select loaitapchi,";
                                            $i = $nambd;
                                            while ($i < $namkt) {
                                            ...
                                            $sql = $sql . " sum(if(nam=$i,soluong,0))as 'năm $i'";
                                            $sql = $sql . " FROM bang33 where nam between $nambd and $namkt GROUP BY loaitapchi DESC";
                                        ...
                                        $sql = "SELECT * FROM bang33 order by nam DESC";
                                        echo'<tr class="bangxem--title">
                                            <td class="bangxem-header">Phân loại tạp chí</td>
                                        ...
                                        while($row = mysqli_fetch_assoc($rs)){
                                            echo '<tr class="bangxem--title">';
                                                ...
                                                echo '<td>'.$row['nam'].'</td>';
                                                echo '<td><label class="btnsua"><a href="../formsua/suabang33.php?nam='.$row['nam'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                    ...
                                                    <label class="btnxoa"><a href="../formxoa/xoabang33.php?id='.$row['id'].'">
                                                    <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                    <lord-icon
