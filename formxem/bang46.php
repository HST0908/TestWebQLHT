...
<head>
    ...
    <title>TỔNG CHI CHO HOẠT ĐỘNG ĐÀO TẠO</title>
</head>
<body>
<?php 
    ...
    <div class="contain grid lager wide">
        <div class="row">
            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        <div class="container_header"><h3 class="heading_title">TỔNG CHI CHO HOẠT ĐỘNG ĐÀO TẠO</h3></div>
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang46.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    ...
                                    if(isset($_POST['xem'])){
                                        ...
                                        $sql = "SELECT * FROM bang46 order by nam desc";
                                    ...
                                    while($row = mysqli_fetch_assoc($rs)){
                                        echo '<tr class="bangxem--title">';
                                            echo '<td>'.$i++.'</td>';
                                            echo '<td>'.$row['nam'].'</td>';
                                            echo '<td>'.number_format($row['chiHDDT'], 0, '.','.').'</td>';
                                            if ($user['role'] == 1){
                                            echo '<td><label class="btnsua"><a href="../formsua/suabang46.php?id='.$row['id'].'">
                                            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                ...
                                                <label class="btnxoa"><a href="../formxoa/xoabang46.php?id='.$row['id'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                <lord-icon
