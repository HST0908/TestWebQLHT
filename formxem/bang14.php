...
<head>
    ...
    <title>DANH SÁCH ĐƠN VỊ TRỰC THUỘC (BAO GỒM CÁC TRUNG TÂM NGHIÊN CỨU, CHI NHÁNH/CƠ SỞ CỦA CÁC ĐƠN VỊ)</title>
</head>
<body>
<?php 
    ...
    <div class="contain grid lager wide">
        <div class="row">
            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        <div class="container_header"><h3 class="heading_title"> DANH SÁCH ĐƠN VỊ TRỰC THUỘC (BAO GỒM CÁC TRUNG TÂM NGHIÊN CỨU, CHI NHÁNH/CƠ SỞ CỦA CÁC ĐƠN VỊ)</h3></div>
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang14.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    <tr class="bangxem--title">
                                        ...
                                        <td class="bangxem-header">Tên đơn vị</td>
                                        <td class="bangxem-header">Năm thành lập</td>
                                        <td class="bangxem-header">Lĩnh vực hoạt động</td>
                                        <td class="bangxem-header">Số lượng nghiên cứu viên</td>
                                        <td class="bangxem-header">Số lượng cán bộ/nhân viên</td>
                                    ...
                                    if(isset($_POST['xem'])){
                                        ...
                                        $sql = "SELECT * FROM bang14 order by namnhapds desc";
                                    ...
                                    while($row = mysqli_fetch_assoc($rs)){
                                        echo '<tr class="bangxem--title">';
                                            ...
                                            echo '<td>'.$row['namthanhlap'].'</td>';
                                            echo '<td>'.$row['linhvuchd'].'</td>';
                                            echo '<td>'.$row['slnghiencuuvien'].'</td>';
                                            echo '<td>'.$row['slnhanvien'].'</td>';
                                            echo '<td>'.$row['namnhapds'].'</td>';
                                            echo '<td><label class="btnsua"><a href="../formsua/suabang14.php?id='.$row['id'].'">
                                            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                ...
                                                <label class="btnxoa"><a href="../formxoa/xoabang14.php?id='.$row['id'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                <lord-icon
