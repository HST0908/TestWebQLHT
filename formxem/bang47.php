            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        ...
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang47.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    ...
                                    if(isset($_POST['xem'])){
                                        $nambd = $_POST['nambd'];
                                        $namkt = $_POST['namkt'];
                                        $sql = "SELECT * FROM bang47 where nam between $nambd and $namkt ORDER BY nam DESC";
                                    }else{
                                        $sql = "SELECT * FROM bang47 order by nam desc";
                                    ...
                                    while($row = mysqli_fetch_assoc($rs)){
                                        echo '<tr class="bangxem--title">';
                                            echo '<td>'.$i++.'</td>';
                                            echo '<td>'.$row['nam'].'</td>';
                                            echo '<td>'.number_format($row['chiPTdoingu'], 0, '.','.').'</td>';
                                            if($user['role'] == 1) {
                                            echo '<td><label class="btnsua"><a href="../formsua/suabang47.php?id='.$row['id'].'">
                                            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                ...
                                                <label class="btnxoa"><a href="../formxoa/xoabang47.php?id='.$row['id'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                <lord-icon
