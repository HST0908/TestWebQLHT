            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        ...
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang40.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    <tr class="bangxem--title">
                                        ...
                                        <td class="bangxem-header">Khối nghành/ Nhóm nghành</td>
                                        <td class="bangxem-header">Đầu sách</td>
                                        <td class="bangxem-header">Bản sách</td>
                                    ...
                                    if(isset($_POST['xem'])){
                                        ...
                                        $sql = "SELECT * FROM bang40 order by nam desc";
                                    ...
                                    while($row = mysqli_fetch_assoc($rs)){
                                        echo '<tr class="bangxem--title">';
                                            echo '<td>'.$row['nam'].'</td>';
                                            echo '<td>'.$row['khoinganh'].'</td>';
                                            echo '<td>'.$row['dausach'].'</td>';
                                            echo '<td>'.$row['bansach'].'</td>';
                                            echo '<td><label class="btnsua"><a href="../formsua/suabang40.php?id='.$row['id'].'">
                                            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                ...
                                                <label class="btnxoa"><a href="../formxoa/xoabang40.php?id='.$row['id'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                <lord-icon
