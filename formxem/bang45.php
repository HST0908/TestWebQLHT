...
<head>
    ...
    <title>TỔNG THU TỪ HOẠT ĐỘNG NGHIÊN CỨU KHOA HỌC, CHUYỂN GIAO CÔNG NGHỆ VÀ PHỤC VỤ CỘNG ĐỒNG</title>
</head>
<body>
<?php 
    ...
    <div class="contain grid lager wide">
        <div class="row">
            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        <div class="container_header"><h3 class="heading_title">TỔNG THU TỪ HOẠT ĐỘNG NGHIÊN CỨU KHOA HỌC, CHUYỂN GIAO CÔNG NGHỆ VÀ PHỤC VỤ CỘNG ĐỒNG</h3></div>
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang45.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    <tr class="bangxem--title">
                                        ...
                                        <td class="bangxem-header">Tổng thu</td>
                                    ...
                                    if(isset($_POST['xem'])){
                                        $nambd = $_POST['nambd'];
                                        $namkt = $_POST['namkt'];
                                        $sql = "SELECT * FROM bang45 where nam between $nambd and $namkt ORDER BY nam DESC";
                                    }else{
                                        $sql = "SELECT * FROM bang45 order by nam desc";
                                    ...
                                    while($row = mysqli_fetch_assoc($rs)){
                                        echo '<tr class="bangxem--title">';
                                            echo '<td>'.$i++.'</td>';
                                            echo '<td>'.$row['nam'].'</td>';
                                            echo '<td>'.number_format($row['thuNCKH'], 0, '.','.').'</td>';
                                            echo '<td><label class="btnsua"><a href="../formsua/suabang45.php?id='.$row['id'].'">
                                            <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                ...
                                                <label class="btnxoa"><a href="../formxoa/xoabang45.php?id='.$row['id'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                <lord-icon
