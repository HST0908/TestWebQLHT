            ...
            <div class="col l-10 m-12 c-12 app__content" >
                <div class="row">
                    <div class="container">
                        ...
                        <div class="toolbar">
                            <form name="dulieuex" id="dulieuex" action="../libs/exlbang26.php" method="post" class="gia111">
                            ...
                            <table class="bang_xem" border="0">
                                <tbody class="than_bang_xem">
                                    ...
                                    if(isset($_POST['xem'])){
                                        $nambd = $_POST['nambd'];
                                        $namkt = $_POST['namkt'];
                                        $sql1 = "SELECT * FROM bang26 where namhoc between $nambd and $namkt ORDER BY namhoc ASC";
                                        ...
                                        echo'</tr class="bangxem--title">';
                                        $sql = "SELECT * FROM bang26 order by namhoc ASC";
                                        ...
                                        while($row = mysqli_fetch_assoc($rs)){
                                            echo '<tr class="bangxem--title">';
                                                ...
                                                echo '<td align=center><label class="btnsua"><a href="../formsua/suabang26.php?namhoc='.$row['namhoc'].'">
                                                <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                    ...
                                                    <label class="btnxoa"><a href="../formxoa/xoabang26.php?id='.$row['id'].'">
                                                    <script src="https://cdn.lordicon.com/xdjxvujz.js"></script>
                                                    <lord-icon
